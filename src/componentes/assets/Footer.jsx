...
function Footer() {
  return (
    <footer className="bg-gray-900 text-customA py-8 text-lg">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          ...
          <a
            href="#"
            className="mt-8 inline-block rounded-full border border-gray-100 px-12 py-3 text-sm font-medium text-white hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
          >
            Agenda tu cita
          </a>
        </div>
